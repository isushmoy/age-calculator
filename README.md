...
1. make the image circle and give it color 
2. make the result look bigger and italic
3. grasp the content of vue
4. take the input of users
5. count
6. send it back to result part
7. implement the stuffs that they can't enter and red light


Features
1. zodiac and chinese zodiac